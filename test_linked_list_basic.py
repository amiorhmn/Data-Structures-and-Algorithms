import pytest
from linked_list_basic import LinkedList
...
def test_prepend(linked_list):
    ...
    assert linked_list.head.value == "Start"
...
def test_insert_head(linked_list):
    ...
    assert linked_list.head.value == "X"
...
def test_reverse():
    ...
    assert ll_1.head.value == "A"

    ll_2 = LinkedList()
    ll_2.append("A")
    ll_2.append("B")
    assert repr(ll_2.reverse()) == "B, A"
    assert ll_2.get_value(0) == "B"
    assert ll_2.get_value(1) == "A"
    assert ll_2.head.value == "B"
